...
public class WebLoggingConfiguration {
    ...
    public static void checkLoggingConfig() throws FileNotFoundException {
        String output = """
                ...
                appender.serverlog.fileName = server.web.log
                ...
                appender.errorfile.fileName = error.web.log
        ...
        File loggingConfig = new File("log4j2.web.properties");
